...
import com.zara.prices.utils.TestUtils;
...
public class PriceIT {
    ...
    void testGetActivePrice(
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/prices/active")
                .param("date", dateTime)
                .param("productId", productId)
                .param("brandId", brandId))
            .andExpect(MockMvcResultMatchers.status().isOk())
            .andExpect(MockMvcResultMatchers.content().contentType(MediaType.APPLICATION_JSON))
            .andDo(result -> JSONAssert.assertEquals(expectedJson, result.getResponse().getContentAsString(), false));
    }
