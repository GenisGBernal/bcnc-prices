...
import com.zara.prices.controller.adapters.PriceControllerAdapter;
...
public class PriceControllerAdapterTest {
    ...
    @InjectMocks
    private PriceControllerAdapter adapter;
    @Mock
    private PriceUseCasePort priceUseCasePort;
    @Mock
    private PriceControllerMapper priceControllerMapper;
    @Mock
    private DateTimeControllerMapper dateTimeControllerMapper;
    ...
    class GetActivePrice {
        ...
        void shouldThrowBadRequestException_whenInvalidStringDateRequest() {
            ...
            when(dateTimeControllerMapper.toDomain(date))
        ...
        void shouldReturnActivePriceDTO_whenSuccessfulSearch() {
            ...
            when(priceControllerMapper.toResponse(activePrice))
